...
const SideBar = () => {
  return (
    <div className="bg-[#101113] h-screen w-14 flex flex-col justify-between items-center py-6 border-r-2 border-[#343A40] fixed z-10">
      {/* logo */}
      ...
      {/* icons */}
      <div className="text-[#AEAEAE] text-2xl space-y-10 flex flex-col items-center mb-24">
        <div>
